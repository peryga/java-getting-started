...
<div class="jumbotron text-center">
  <div class="container">
    ...
    <h1>Getting Started with Java on Heroku aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</h1>
...
<div class="container">
  <div class="alert alert-info text-center" role="alert">
    To deploy your own copy, ccccccccccccccccccccccc and learn the fundamentals of the Heroku platform, head over to the <a href="https://devcenter.heroku.com/articles/getting-started-with-java" class="alert-link">Getting Started with Java on Heroku</a> tutorial.
  </div>
  <hr>
  <div class="row">
    <div class="col-md-6">
